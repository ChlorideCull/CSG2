...
Contains minor patches for CSG2. You can find them by grepping for '# CSG2 PATCH'.
This file is based off bottle.py GIT revision b2da90e751a9be319dc70b30ae741eee61ee689f
"""
...
class BaseTemplate(object):
    ...
    def search(cls, name, lookup=None):
        ...
        if os.path.isabs(name):
            return name  # CSG2 PATCH: We heavily rely on absolute paths, so we cannot deprecate them.
